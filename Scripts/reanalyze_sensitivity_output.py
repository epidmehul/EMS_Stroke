...
if __name__ == '__main__':
    ...
    psc_grouped_avgs, psc_intervals= zip(*high_psc_results)
    ...
    psc_grouped_avgs, psc_intervals= zip(*mid_psc_results)
    ...
    psc_grouped_avgs, psc_intervals= zip(*low_psc_results)
