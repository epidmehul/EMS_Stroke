...
python ../Scripts/rng_to_config.py -m 5
python ../Scripts/rng_to_config.py -m 6
python ../Scripts/rng_to_config.py -m 7

python ../Scripts/run_and_analyze_combinations.py -n 5 -c ../config_files/test2.yaml -d ../input_data/patient_0.csv -t ../input_data/map_5.csv -f ../config_files/cohort_nums.csv -o /work/users/p/w/pwlin/output_map5/parquet_files

python ../Scripts/run_and_analyze_combinations.py -n 5 -c ../config_files/test2.yaml -d ../input_data/patient_0.csv -t ../input_data/map_6.csv -f ../config_files/cohort_nums.csv -o /work/users/p/w/pwlin/output_map6/parquet_files

python ../Scripts/run_and_analyze_combinations.py -n 5 -c ../config_files/test2.yaml -d ../input_data/patient_0.csv -t ../input_data/map_7.csv -f ../config_files/cohort_nums.csv -o /work/users/p/w/pwlin/output_map7/parquet_files
